...
//        var_dump($alipay_config);
        ...
        //必填，不能修改
        //服务器异步通知页面路径
        $notify_url = 'http://www.artvc.com/create_direct_pay_by_user-PHP-UTF-8/notify_url.php';
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        $return_url = 'http://www.artvc.com/create_direct_pay_by_user-PHP-UTF-8/return_url.php';
        //需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/

        //商户订单号
        // $out_trade_no = $_POST['WIDout_trade_no'];
        $out_trade_no = '12121212121';
        //商户网站订单系统中唯一订单号，必填
