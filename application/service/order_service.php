...
class Order_service extends MY_Service
{
    ...
    public function buy_production($user_id, $contact_id, $transport_id, $issue_header, $production_id, $frame_id)
    {
        ...
        //check production and frame
        $query = $this->production_model->get_production_with_frame($production_id, $frame_id);
        ...
        $this->order_model->update_orderItem_by_production($user_id, $order_id, $production_id, $frame_id);
     ...
     * 支付成功，艺术品已出售
     */
    public function complete_transaction($order_no)
    {
