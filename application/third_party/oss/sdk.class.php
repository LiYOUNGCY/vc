...
class ALIOSS
{
     ...
     *
     * @param int $filesize  (Required) 文件大小
     * @param int $part_size (Required) part大小,默认5M
     *
    ...
    public function complete_multipart_upload($bucket, $object, $upload_id, $parts, $options = null)
    {
        ...
        } elseif ((is_array($parts) || $parts instanceof ResponseCore)) {
     ...
     * @param bool   $recursive (Optional) 是否递归，如果为true，则递归读取所有目录，默认为不递归读取
