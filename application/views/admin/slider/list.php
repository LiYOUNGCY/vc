                                    ...
                                    <?php foreach ($slider as $k => $v) {
                                        ...
                                        <tr class="selected">
                                            ...
                                            <td class="tooltip-btn">
                                                <button data-toggle="tooltip" title="预览" effect="check"
                                                        u="<?= $v['pic'] ?>" type="button"
                                                        class="btn btn-success btn-circle"><i class="fa fa-eye"></i>
                                                </button>
                            ...
                            <div class="tab-pane fade" id="add">
                                <table class="table table-striped">
                                    <form id="add_form" method="post"
                                          action="<?=base_url()?>artvc/admin/slider/add_slider">
                                        <tbody>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5 col-xs-8">
                                                        <input class="form-control" style="float:left;width:85%;"
                                                               name="pic" type="text"/>
                                                        <button type="button" id="check_newpic" style="float:left;"
                                                                class="btn btn-outline btn-primary">预览
                                                        </button>
                                                        <input type="file" name="upfile" id="upfile" style="float:left;"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <span class="col-sm-4 col-xs-3 control-label">类型:</span>
