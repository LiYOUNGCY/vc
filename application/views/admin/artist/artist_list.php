                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div style="margin-bottom: 10px;">
                            <button id="publish_article" type="button" class="btn btn-outline btn-default">发布艺术家</button>
                        </div>
                        <!--表格-->
    ...
    ?>
                                <tr class="selected">
                                    ...
                                    <td class="tooltip-btn">
                                        <button data-toggle="tooltip" title="查看艺术家" effect="check" u="<?= $v['id'] ?>" type="button" class="btn btn-success btn-circle"><i class="fa fa-eye"></i>
                                        </button>
...
<script type="text/javascript">
    ...
    var ADMIN = $("#ADMIN").val();
    var DELETE_URL = ADMIN + 'artist/delete_artist';
    $(function () {
        $('.tooltip-btn').tooltip({
        ...
        $("button[effect=check]").click(function () {
            var aid = $(this).attr('u');
            if (aid != null && aid != "") {
                window.location.href = BASE_URL + 'artist/' + aid;
            }
        });
        ...
        $("button[effect=edit]").click(function () {
            var aid = $(this).attr('u');
            if (aid != null && aid != "") {
                window.location.href = BASE_URL + 'update/artist/' + aid;
            }
        });
        ...
        $("button[effect=publish]").click(function () {
            ...
            if (aid != null && aid != "") {
                $.ajax({
                    url: BASE_URL + 'artist/publish/publish',
                    data: {
                        id: aid
                    },
                    dataType: 'json',
        ...
        $("button[effect=cancel]").click(function () {
            ...
            if (aid != null && aid != "") {
                $.ajax({
                    url: BASE_URL + 'artist/publish/cancel_publish',
                    data: {
                        id: aid
                    },
                    dataType: 'json',
        ...
        $('#publish_article').click(function () {
            window.location.href = BASE_URL + 'publish/artist';
        });
    });
</script>
</body>
