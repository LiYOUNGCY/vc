                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#list" data-toggle="tab" aria-expanded="true">收藏的标签列表</a>
                            </li>
                            <li><a href="#add" data-toggle="tab" aria-expanded="false">添加收藏的标签</a>
                            </li>
                        </ul>
                        <!--表格-->
    ...
    ?>
                            ...
                            <div class="tab-pane fade" id="add">
                                <table class="table table-striped">
                                    <form id="add_form" method="post" action="<?= base_url() ?>admin/topic/add_when">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <span class="col-sm-4 col-xs-3 control-label">收藏的标签名称:</span>
...
<script type="text/javascript">
    ...
    var ADMIN = $("#ADMIN").val();
    var DELETE_URL = ADMIN + 'topic/delete_when';
    $(function () {
        $('.tooltip-btn').tooltip({
        ...
        $("button[effect=edit]").click(function () {
            var id = $(this).attr('u');
            if (id != null && id != "") {
                window.location.href = BASE_URL + 'admin/topic/when/update/' + id;
            }
        });
    });
</script>
