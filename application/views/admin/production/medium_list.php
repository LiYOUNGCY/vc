                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#list" data-toggle="tab" aria-expanded="true">题材列表</a>
                            </li>
                            <li><a href="#add" data-toggle="tab" aria-expanded="false">添加题材</a>
                            </li>
                        </ul>
                        <!--表格-->
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <span class="col-sm-4 col-xs-3 control-label">题材名称:</span>
