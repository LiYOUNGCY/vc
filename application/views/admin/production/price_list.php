                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#list" data-toggle="tab" aria-expanded="true">价格分类列表</a>
                            </li>
                            <li><a href="#add" data-toggle="tab" aria-expanded="false">添加价格分类</a>
                            </li>
                        </ul>
                        <!--表格-->
                            ...
                            <div class="tab-pane fade" id="add">
                                <table class="table table-striped">
                                    <form id="add_form" method="post"
                                          action="<?= base_url() ?>admin/production/add_price">
                                        <tbody>
                                        <!--                                        <tr>-->
                                        <!--                                            <td>-->
...
<script type="text/javascript">
    ...
    var ADMIN = $("#ADMIN").val();
    var DELETE_URL = ADMIN + 'production/delete_price';
    $(function () {
        $('.tooltip-btn').tooltip({
        ...
        $("button[effect=edit]").click(function () {
            var id = $(this).attr('u');
            if (id != null && id != "") {
                window.location.href = BASE_URL + 'admin/production/price/update/' + id;
            }
        });
    });
</script>
