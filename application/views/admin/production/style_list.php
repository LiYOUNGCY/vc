                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#list" data-toggle="tab" aria-expanded="true">风格列表</a>
                            </li>
                            <li><a href="#add" data-toggle="tab" aria-expanded="false">添加风格</a>
                            </li>
                        </ul>
                        <!--表格-->
                        <div class="tab-content" style="padding:10px 0px 0px 0px;">
                            ...
                            <div class="tab-pane fade" id="add">
                                <table class="table table-striped">
                                    <form id="add_form" method="post" action="<?= base_url() ?>admin/production/add_style">
                                        <tbody>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <span class="col-sm-4 col-xs-3 control-label">风格名称:</span>
...
<script type="text/javascript">
    ...
    var ADMIN = $("#ADMIN").val();
    var DELETE_URL = ADMIN + 'production/delete_style';
    $(function () {
        $('.tooltip-btn').tooltip({
        ...
        $("button[effect=edit]").click(function () {
            var id = $(this).attr('u');
            if (id != null && id != "") {
                window.location.href = BASE_URL + 'admin/production/style/update/' + id;
            }
        });
    });
</script>
