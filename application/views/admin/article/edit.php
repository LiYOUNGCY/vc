                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5 col-xs-8">
                                                        <input class="form-control" name="article_title" type="text" value="<?=$article['title']?>">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5 col-xs-8">
                                                        <input class="form-control" name="article_subtitle" type="text" value="<?=$article['subtitle']?>">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
