       ...
       <a href="#"> 
        ...
        <div id="vi_container" class="container">
            ...
            <div id="vl_content" class="content">
                ...
                <div class="logtext">
                       <div class="float-l">
                           欢迎登陆<font style="margin:0 10px;font-size:200%;letter-spacing: 0px;">artVC</font><i style="color:#FCEE21;font-weight: bold;padding:0 10px;font-size:70%;">/</i><font style="font-size:70%;text-decoration: underline;"><a href="#">注册账号</a></font>
                       </div>
                </div>
